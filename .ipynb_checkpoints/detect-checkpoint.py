...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    la = (dt[0] + dt[1] + dt[2]) / seen
    print('latency:', la * 1E3, 'ms   FPS', 1.0/la)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='../autodl-tmp/dataset/val_split/images/', help='file/dir/URL/glob, 0 for webcam')
