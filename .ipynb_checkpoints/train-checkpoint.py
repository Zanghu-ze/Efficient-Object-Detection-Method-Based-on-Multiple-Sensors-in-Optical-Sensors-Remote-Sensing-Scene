...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp25/weights/best.pt', help='initial weights path') # ROOT / 'weights/yolov5m.pt'
    parser.add_argument('--cfg', type=str, default='./models/ouryolov5s.yaml', help='model.yaml path')
